...
PROJECT_NAME ?= provider-upjet-ionoscloud
PROJECT_REPO ?= github.com/ionos-cloud/$(PROJECT_NAME)

export OPENTOFU_VERSION ?= 1.12.4
...
export TERRAFORM_PROVIDER_VERSION ?= 6.7.36
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-ionoscloud_v6_7_36
...
REGISTRY_ORGS ?= xpkg.upbound.io/ionos-cloud
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= xpkg.upbound.io/ionos-cloud
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/ionos-cloud
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-upjet-ionoscloud: do.build.images
