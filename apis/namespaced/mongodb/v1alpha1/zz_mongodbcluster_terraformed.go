...
func (mg *MongodbCluster) GetTerraformResourceType() string {
	return "ionoscloud_mongo_cluster"
}
...
func (tr *MongodbCluster) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("Cores"))
	opts = append(opts, resource.WithNameFilter("RAM"))
	opts = append(opts, resource.WithNameFilter("StorageSize"))
	opts = append(opts, resource.WithNameFilter("TemplateID"))
