...
func (mg *MongodbCluster) ResolveReferences( // ResolveReferences of this MongodbCluster.
...
func (mg *MongodbUser) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("mongodb.upjet-ionoscloud.ionoscloud.io", "v1alpha1", "MongodbCluster", "MongodbClusterList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
