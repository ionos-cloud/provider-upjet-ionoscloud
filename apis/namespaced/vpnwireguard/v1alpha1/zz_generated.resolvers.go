...
func (mg *VpnWireguardGateway) ResolveReferences( // ResolveReferences of this VpnWireguardGateway.
...
func (mg *VpnWireguardPeer) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("vpnwireguard.m.ionoscloud.io", "v1alpha1", "VpnWireguardGateway", "VpnWireguardGatewayList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
