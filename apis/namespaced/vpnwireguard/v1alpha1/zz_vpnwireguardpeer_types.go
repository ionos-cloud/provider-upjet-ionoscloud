...
type VpnWireguardPeerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/namespaced/vpnwireguard/v1alpha1.VpnWireguardGateway
...
// VpnWireguardPeer is the Schema for the VpnWireguardPeers API. Creates and manages IONOS CLOUD VPN Wireguard Gateway Peer objects.
