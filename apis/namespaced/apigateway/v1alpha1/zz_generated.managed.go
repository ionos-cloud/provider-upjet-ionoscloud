...
func (mg *Apigateway) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this Apigateway.
func (mg *Apigateway) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *Apigateway) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this Apigateway.
func (mg *Apigateway) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
