...
type BootDeviceSelectionInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/namespaced/compute/v1alpha1.Volume
	...
	BootDeviceIDRef *v1.NamespacedReference `json:"bootDeviceIdRef,omitempty" tf:"-"`

	// Selector for a Volume in compute to populate bootDeviceId.
	// +kubebuilder:validation:Optional
	BootDeviceIDSelector *v1.NamespacedSelector `json:"bootDeviceIdSelector,omitempty" tf:"-"`
