...
func (mg *InMemoryDBReplicaset) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this InMemoryDBReplicaset.
func (mg *InMemoryDBReplicaset) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *InMemoryDBReplicaset) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this InMemoryDBReplicaset.
func (mg *InMemoryDBReplicaset) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
