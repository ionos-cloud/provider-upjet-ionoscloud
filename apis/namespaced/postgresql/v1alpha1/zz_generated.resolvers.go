...
func (mg *PostgresqlCluster) ResolveReferences( // ResolveReferences of this PostgresqlCluster.
...
func (mg *PostgresqlDatabase) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("postgresql.m.ionoscloud.io", "v1alpha1", "PostgresqlCluster", "PostgresqlClusterList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
