...
func (mg *MariadbCluster) GetProviderConfigReference() *xpv1.ProviderConfigReference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this MariadbCluster.
func (mg *MariadbCluster) GetWriteConnectionSecretToReference() *xpv1.LocalSecretReference {
...
func (mg *MariadbCluster) SetProviderConfigReference(r *xpv1.ProviderConfigReference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this MariadbCluster.
func (mg *MariadbCluster) SetWriteConnectionSecretToReference(r *xpv1.LocalSecretReference) {
