...
func (mg *VpnIpsecGateway) ResolveReferences( // ResolveReferences of this VpnIpsecGateway.
...
func (mg *VpnIpsecTunnel) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("vpnipsec.upjet-ionoscloud.ionoscloud.io", "v1alpha1", "VpnIpsecGateway", "VpnIpsecGatewayList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
