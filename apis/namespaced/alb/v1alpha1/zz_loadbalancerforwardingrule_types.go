...
type LoadbalancerForwardingruleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/namespaced/alb/v1alpha1.Loadbalancer
	...
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/namespaced/certificatemanager/v1alpha1.Certificate
	...
	// +kubebuilder:validation:Optional
	ServerCertificatesRefs []v1.NamespacedReference `json:"serverCertificatesRefs,omitempty" tf:"-"`

	// Selector for a list of Certificate in certificatemanager to populate serverCertificates.
	// +kubebuilder:validation:Optional
	ServerCertificatesSelector *v1.NamespacedSelector `json:"serverCertificatesSelector,omitempty" tf:"-"`
}
