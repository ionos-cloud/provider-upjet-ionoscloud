...
type FirewallInitParameters_2 struct {
	...
	// [string] The NIC ID.
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/cluster/compute/v1alpha1.Nic
	...
	// Reference to a GPUServer in compute to populate serverId.
	// +kubebuilder:validation:Optional
	ServerIDRef *v1.Reference `json:"serverIdRef,omitempty" tf:"-"`

	// Selector for a GPUServer in compute to populate serverId.
	// +kubebuilder:validation:Optional
