...
func (mg *BootDeviceSelection) ResolveReferences( // ResolveReferences of this BootDeviceSelection.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.ionoscloud.io", "v1alpha1", "Volume", "VolumeList")
		if err != nil {
...
func (mg *CubeServer) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	if mg.Spec.ForProvider.Nic != nil {
		{
			m, l, err = apisresolver.GetManagedResource("compute.ionoscloud.io", "v1alpha1", "NSG", "NSGList")
			if err != nil {
				return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
			}
...
func (mg *Firewall) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.DatacenterIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.ionoscloud.io", "v1alpha1", "Nic", "NicList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Lan) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	mg.Spec.ForProvider.DatacenterIDRef = rsp.ResolvedReference
	{
		m, l, err = apisresolver.GetManagedResource("compute.ionoscloud.io", "v1alpha1", "Crossconnect", "CrossconnectList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
...
func (mg *Share) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("compute.ionoscloud.io", "v1alpha1", "Group", "GroupList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
