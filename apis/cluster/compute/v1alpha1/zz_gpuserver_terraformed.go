...
func (tr *GPUServer) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"image_password": "imagePasswordSecretRef"}
}

// GetObservation of this GPUServer
func (tr *GPUServer) GetObservation() (map[string]any, error) {
...
// SetObservation for this GPUServer
func (tr *GPUServer) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this GPUServer
func (tr *GPUServer) GetID() string {
...
// GetParameters of this GPUServer
func (tr *GPUServer) GetParameters() (map[string]any, error) {
...
// SetParameters for this GPUServer
func (tr *GPUServer) SetParameters(params map[string]any) error {
...
// GetInitParameters of this GPUServer
func (tr *GPUServer) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this GPUServer
func (tr *GPUServer) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
...
// LateInitialize this GPUServer using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *GPUServer) LateInitialize(attrs []byte) (bool, error) {
	params := &GPUServerParameters{}
...
func (tr *GPUServer) GetTerraformSchemaVersion() int {
	return 0
}
