...
type GPUServerInitParameters struct {
	...
	Volume *GPUServerVolumeInitParameters `json:"volume,omitempty" tf:"volume,omitempty"`
}

type GPUServerNicFirewallInitParameters struct {
...
type GPUServerNicFirewallObservation struct {
...
type GPUServerNicFirewallParameters struct {
...
type GPUServerNicInitParameters struct {
	...
	Firewall *GPUServerNicFirewallInitParameters `json:"firewall,omitempty" tf:"firewall,omitempty"`
...
type GPUServerNicObservation struct {
	DHCP *bool `json:"dhcp,omitempty" tf:"dhcp,omitempty"`
	...
	// Allows to define firewall rules inline in the server. See the Firewall section.
	// Firewall rules created in the server resource. The rules can also be created as separate resources outside the server resource
	Firewall *GPUServerNicFirewallObservation `json:"firewall,omitempty" tf:"firewall,omitempty"`
...
type GPUServerNicParameters struct {
	...
	// Firewall rules created in the server resource. The rules can also be created as separate resources outside the server resource
	// +kubebuilder:validation:Optional
	Firewall *GPUServerNicFirewallParameters `json:"firewall,omitempty" tf:"firewall,omitempty"`
...
type GPUServerObservation struct {
	...
	// See the Nic section.
	Nic *GPUServerNicObservation `json:"nic,omitempty" tf:"nic,omitempty"`
	...
	// See the Volume section.
	Volume *GPUServerVolumeObservation `json:"volume,omitempty" tf:"volume,omitempty"`
}

type GPUServerParameters struct {
	...
	// See the Volume section.
	// +kubebuilder:validation:Optional
	Volume *GPUServerVolumeParameters `json:"volume,omitempty" tf:"volume,omitempty"`
}

type GPUServerVolumeInitParameters struct {
...
type GPUServerVolumeObservation struct {
...
type GPUServerVolumeParameters struct {
...
// GPUServerSpec defines the desired state of GPUServer
type GPUServerSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     GPUServerParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider GPUServerInitParameters `json:"initProvider,omitempty"`
}

// GPUServerStatus defines the observed state of GPUServer.
type GPUServerStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        GPUServerObservation `json:"atProvider,omitempty"`
}
...
// GPUServer is the Schema for the GPUServers API. Creates and manages IonosCloud Server objects.
...
type GPUServer struct {
	...
	Spec   GPUServerSpec   `json:"spec"`
	Status GPUServerStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// GPUServerList contains a list of GPUServers
type GPUServerList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []GPUServer `json:"items"`
}

// Repository type metadata.
var (
	GPUServer_Kind             = "GPUServer"
	GPUServer_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: GPUServer_Kind}.String()
	GPUServer_KindAPIVersion   = GPUServer_Kind + "." + CRDGroupVersion.String()
	GPUServer_GroupVersionKind = CRDGroupVersion.WithKind(GPUServer_Kind)
)

func init() {
	SchemeBuilder.Register(&GPUServer{}, &GPUServerList{})
}
