...
func (mg *AutoscalingGroup) GetTerraformResourceType() string {
	return "ionoscloud_autoscaling_group"
}
...
func (tr *AutoscalingGroup) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"replica_configuration[*].volume[*].image_password": "replicaConfiguration[*].volume[*].imagePasswordSecretRef"}
}
