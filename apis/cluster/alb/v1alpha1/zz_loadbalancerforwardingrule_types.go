...
type LoadbalancerForwardingruleInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/cluster/alb/v1alpha1.Loadbalancer
	...
	// +crossplane:generate:reference:type=github.com/ionos-cloud/provider-upjet-ionoscloud/apis/cluster/certificatemanager/v1alpha1.Certificate
