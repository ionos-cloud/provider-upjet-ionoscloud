...
type ObjectCopyInitParameters struct {
	...
	// Specifies the 128-bit MD5 digest of the encryption key according to RFC 1321. IONOS S3 Object Copy Storage uses this header for a message integrity check  to ensure that the encryption key was transmitted without error
	...
	// If the bucket is configured as a website, redirects requests for this object copy to another object copy in the same bucket or to an external URL. IONOS S3 Object Copy Storage stores the value of this header in the object copy metadata
...
// ObjectCopy is the Schema for the ObjectCopys API. Creates a copy of an object that is already stored in IONOS S3 Object Storage.
