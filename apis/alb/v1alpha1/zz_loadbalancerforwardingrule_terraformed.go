...
func (mg *LoadbalancerForwardingrule) GetTerraformResourceType() string {
	return "ionoscloud_application_loadbalancer_forwardingrule"
}
...
// LateInitialize this LoadbalancerForwardingrule using its observed tfState.
// returns True if there are any spec changes for the resource.
func (tr *LoadbalancerForwardingrule) LateInitialize(attrs []byte) (bool, error) {
	params := &LoadbalancerForwardingruleParameters{}
