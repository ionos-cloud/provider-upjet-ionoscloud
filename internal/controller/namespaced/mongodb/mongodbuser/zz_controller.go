...
import (
	...
	v1alpha1 "github.com/ionos-cloud/provider-upjet-ionoscloud/apis/namespaced/mongodb/v1alpha1"
...
func Setup(mgr ctrl.Manager, o tjcontroller.Options) error {
	...
	opts := []managed.ReconcilerOption{
		managed.WithExternalConnecter(
			tjcontroller.NewTerraformPluginSDKAsyncConnector(mgr.GetClient(), o.OperationTrackerStore, o.SetupFn, o.Provider.Resources["ionoscloud_mongo_user"],
				...
				tjcontroller.WithTerraformPluginSDKAsyncMetricRecorder(metrics.NewMetricRecorder(v1alpha1.MongodbUser_GroupVersionKind, mgr, o.PollInterval)),
	...
	// if they're enabled.
	if o.StartWebhooks {
		if err := ctrl.NewWebhookManagedBy(mgr, &v1alpha1.MongodbUser{}).
			Complete(); err != nil {
